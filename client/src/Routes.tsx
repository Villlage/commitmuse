...
import SingleIsa from './app/pages/public/my-isa/single-isa'
  ...
  return (
    <Router>
      <Switch>
        <Route
          path="/my-isa"
          render={(props: any) => <MyIsa {...props} currentUser={currentUser} fetchUser={fetchUser} />}
        />
        <Route
          path="/isa/:id"
          render={(props: any) => <SingleIsa {...props} currentUser={currentUser} fetchUser={fetchUser} />}
        />
        <Route
          path="/on-boarding"
          render={(props: any) => <OnBoarding {...props} currentUser={currentUser} fetchUser={fetchUser} />}
        />
        {/*404*/}
