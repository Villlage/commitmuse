...
export default function TermsAndConditions(props: ScreenProps) {
  return (
    <article className="TermsAndConditions-page">
      <div className="container">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>
        <p>Welcome to Commit Muse!</p>
        <p>
          These terms and conditions outline the rules and regulations for the use of Commit Muse's Website, located at
          https://www.commitmuse.com/.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Commit Muse
        ...
        <p>
          We employ the use of cookies. By accessing Commit Muse, you agreed to use cookies in agreement with the Commit
          Muse's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Commit Muse and/or its licensors own the intellectual property rights for all
          material on Commit Muse. All intellectual property rights are reserved. You may access this from Commit Muse
          for your own personal use subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul role="list">
          <li>Republish material from Commit Muse</li>
          <li>Sell, rent or sub-license material from Commit Muse</li>
          <li>Reproduce, duplicate or copy material from Commit Muse</li>
          <li>Redistribute content from Commit Muse</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Commit Muse does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Commit Muse,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, Commit Muse shall not be liable for the Comments or for any liability, damages
          or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
          Comments on this website.
        </p>
        <p>
          Commit Muse reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Commit Muse a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Commit
          Muse; and (d) the link is in the context of general resource information.
        </p>
        <p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Commit Muse. Please include your name, your organization name,
        ...
        <p>
          No use of Commit Muse's logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
        <h3>
